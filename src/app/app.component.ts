...
export class AppComponent implements OnInit, OnDestroy {
  mapUrls = [ null, 'assets/files/alphagateslayer.png', 'assets/files/betagateslayer.png', 'assets/files/deltagateslayer.png',
             'assets/files/epsilongateslayer.png', 'assets/files/gammagateslayer.png', 'assets/files/lambdagateslayer.png' ];
  mapIndex = 0;
  mapHeight = 1000;
  mapWidth = 1000;
  isOpen = false;
  ...
  // ngAfterViewInit() {
  //   let child: any;
  //   for (let i = 0; i < this.starmap?.nativeElement?.children.length; i++) {
  //     child = this.starmap?.nativeElement?.children.item(i);
  //     if (child.href = "") continue;
  //     let stripped = child.href.replace("https://forums.spacebattles.com/threads/", "")
  //     .replace("post", "")
  //     .replace("/", "")
  //     .replace(".", "")
  //     .replace("0", "")
  ...
  //     .replace("8", "")
  //     .replace("9", "");
  //     let keywords = stripped.split("-");
  //     let properName = keywords.join(" ");
  //     let coords = child.coords.split(",");
  //     this.places.push({
  //       xStart: Number(coords[0]) - Number(coords[2]),
  //       yStart: Number(coords[1]) - Number(coords[2]),
  //       xEnd: Number(coords[0]) + Number(coords[2]),
  //       yEnd: Number(coords[1]) + Number(coords[2]),
